...
class MainWindow(QMainWindow):
    ...
    def search_inventory(self):
        ...
        for item in filtered_inventory:
            ...
            self.inventory_table.setItem(row_position, 5, QTableWidgetItem(item.get('Ausbuchungsdatum', '-')))
            self.inventory_table.setItem(row_position, 6, QTableWidgetItem(item.get('User', '-')))
    ...
    def initUI(self):
        ...
        self.acp_table.setColumnCount(6)  # Ändern Sie diese Zahl entsprechend der Anzahl der benötigten Spalten
        self.acp_table.setHorizontalHeaderLabels(["Modell", "Sprache", "SN", "MAC-Adresse", "Einbuchungsdatum","User"])  # Ändern Sie diese Liste entsprechend Ihren Spalten
